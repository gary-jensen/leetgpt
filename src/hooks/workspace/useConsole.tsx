...
// import { TestValidator } from "@/lib/execution/testValidator";
import { Lesson, TestResult } from "../../features/Workspace/lesson-data/lesson-types";
								...
								try {
									...
									if (!serializedFunction) {
										...
										if (targetFunction) {
											...
											testResult = targetFunction(...testCase.input);
										}
									}
								} catch (e) {
